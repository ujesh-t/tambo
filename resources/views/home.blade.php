					...
					<nav id="nav">
						<ul>
							...
							<li>
								...
								<ul>
									<li><a href="generic.html">Deposit</a></li>
									<li><a href="contact.html">Withdraw</a></li>
			...
			<!-- Main -->
				<section id="main" class="container">
					...
					<section class="box special">
						<header class="major">
							<h2>Introducing the ultimate Tambola app
							<br />
							Backed by Block Chain Technology</h2>
					...
					<section class="box special features">
						<div class="features-row">
							<section>
								...
								<p>Deposit Amount using cryto currencies anywhere from the world. Transfer the amount to your dedicated online wallet address and use it for purchacing tickets</p>
							</section>
							<section>
								<span class="icon major fa-area-chart accent3"></span>
								<h3>Maximum Profit</h3>
								<p>99% of the total income is distributed back to the players as rewards and price money. Making Tambo one of its kind.</p>
							</section>
						</div>
						<div class="features-row">
							<section>
